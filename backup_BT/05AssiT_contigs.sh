...
do
	...
	kraken2 --db /datos/metamex/krakendb --threads 12 \
	...
	ktImportTaxonomy ${work_directory}/results/asstax/contigs/${base}_contigs.krona.input -o ${work_directory}/results/asstax/contigs/${base}_contigs.krona.out.html

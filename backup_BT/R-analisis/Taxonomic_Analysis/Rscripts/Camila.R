...
Camda2023 <- import_biom("Taxonomic_Analysis/biom/LP_all_reads_ALN.biom")
# ReadLevel
...
metadata_Camda2023 <- read.csv2("Taxonomic_Analysis/metadata/metadata.tableR.txt",header =  TRUE, row.names = 1, sep = "\t")
